...
public class JJKSounds {
    ...
    public static RegistryObject<SoundEvent> UNLIMITED_VOID = SOUNDS.register("unlimited_void", () ->
            SoundEvent.createVariableRangeEvent(new ResourceLocation(JujutsuKaisen.MOD_ID, "unlimited_void")));
    ...
    public static RegistryObject<SoundEvent> JACOBS_STRONG_FIRE = SOUNDS.register("jacobs_strong_fire", () ->
            SoundEvent.createVariableRangeEvent(new ResourceLocation(JujutsuKaisen.MOD_ID, "jacobs_strong_fire")));
    ...
    public static RegistryObject<SoundEvent> RED_EXPLOSION = SOUNDS.register("red_explosion", () ->
    ...
    public static RegistryObject<SoundEvent> THUMP = SOUNDS.register("thump", () ->
            SoundEvent.createVariableRangeEvent(new ResourceLocation(JujutsuKaisen.MOD_ID, "thump")));
    public static RegistryObject<SoundEvent> SHOOT = SOUNDS.register("shoot", () ->
