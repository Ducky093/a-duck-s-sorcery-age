...
public class ElectricBeamRenderer extends EntityRenderer<ElectricBeamEntity> {
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(@NotNull ElectricBeamEntity pEntity) {
        return TEXTURE;
    }
