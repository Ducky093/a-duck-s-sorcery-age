...
public enum CursedTechnique {
    ...
    IDLE_TRANSFIGURATION(JJKAbilities.SELF_EMBODIMENT_OF_PERFECTION.get(), JJKAbilities.IDLE_TRANSFIGURATION.get(), JJKAbilities.SOUL_DECIMATION.get(), JJKAbilities.SOUL_REINFORCEMENT.get(),
            JJKAbilities.SOUL_RESTORATION.get(), JJKAbilities.ARM_BLADE.get(), JJKAbilities.GUN.get(), JJKAbilities.HORSE_LEGS.get(), JJKAbilities.WINGS.get(), JJKAbilities.SHRINK.get() , JJKAbilities.TRANSFIGURED_SOUL_SMALL.get(),
    ...
    TECHNIQUELESS(null),
    miracle(JJKAbilities.miracle.get()),
